<template>
  <div class="flick-list" v-on:touchstart="touchKey">
    <div class="flick-median" v-on:touchend.self="touchEnd">は</div>
    <div class="flick-left" v-if="displayKey">ひ</div>
    <div class="flick-top" v-if="displayKey">ふ</div>
    <div class="flick-right" v-if="displayKey">へ</div>
    <div class="flick-bottom" v-if="displayKey">ほ</div>
  </div>
</template>
