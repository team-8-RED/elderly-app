<template>
  <div class="flick-list" v-on:touchstart="touchKey">
    <div class="flick-median" v-on:touchend.self="touchEnd">か</div>
    <div class="flick-left" v-if="displayKey">き</div>
    <div class="flick-top" v-if="displayKey">く</div>
    <div class="flick-right" v-if="displayKey">け</div>
    <div class="flick-bottom" v-if="displayKey">こ</div>
  </div>
</template>
