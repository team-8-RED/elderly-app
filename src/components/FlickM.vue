<template>
  <div class="flick-list" v-on:touchstart="touchKey">
    <div class="flick-median" v-on:touchend.self="touchEnd">ま</div>
    <div class="flick-left" v-if="displayKey">み</div>
    <div class="flick-top" v-if="displayKey">む</div>
    <div class="flick-right" v-if="displayKey">め</div>
    <div class="flick-bottom" v-if="displayKey">も</div>
  </div>
</template>
