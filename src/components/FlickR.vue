<template>
  <div class="flick-list" v-on:touchstart="touchKey">
    <div class="flick-median" v-on:touchend.self="touchEnd">ら</div>
    <div class="flick-left" v-if="displayKey">り</div>
    <div class="flick-top" v-if="displayKey">る</div>
    <div class="flick-right" v-if="displayKey">れ</div>
    <div class="flick-bottom" v-if="displayKey">ろ</div>
  </div>
</template>
