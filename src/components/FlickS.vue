<template>
  <div class="flick-list" v-on:touchstart="touchKey">
    <div class="flick-median" v-on:touchend.self="touchEnd">さ</div>
    <div class="flick-left" v-if="displayKey">し</div>
    <div class="flick-top" v-if="displayKey">す</div>
    <div class="flick-right" v-if="displayKey">せ</div>
    <div class="flick-bottom" v-if="displayKey">そ</div>
  </div>
</template>
