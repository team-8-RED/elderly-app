<template>
  <div class="flick-list" v-on:touchstart="touchKey">
    <div class="flick-median" v-on:touchend.self="touchEnd">た</div>
    <div class="flick-left" v-if="displayKey">ち</div>
    <div class="flick-top" v-if="displayKey">つ</div>
    <div class="flick-right" v-if="displayKey">て</div>
    <div class="flick-bottom" v-if="displayKey">と</div>
  </div>
</template>
