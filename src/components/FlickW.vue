<template>
  <div class="flick-list" v-on:touchstart="touchKey">
    <div class="flick-median" v-on:touchend.self="touchEnd">わ</div>
    <div class="flick-left" v-if="displayKey">を</div>
    <div class="flick-top" v-if="displayKey">ん</div>
    <div class="flick-right" v-if="displayKey">ー</div>
  </div>
</template>
