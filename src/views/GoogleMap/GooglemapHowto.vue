...
export default {
  data() {
    return {
      ImgSrc: [
        require("@/imgs/Safari/Search/search1.png"),

        require("@/imgs/Safari/Search/search2.png"),

        require("@/imgs/Safari/Search/search3.png"),
      ],
      currentIndex: -1,
    }
  },
