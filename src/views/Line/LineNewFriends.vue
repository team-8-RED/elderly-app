...
export default {
  data() {
    return {
      ImgSrc: [
        require("@/imgs/Line/Newfriends/newfriends1.png"),

        require("@/imgs/Line/Newfriends/newfriends2.png"),

        require("@/imgs/Line/Newfriends/newfriends3.png"),
      ],
      currentIndex: -1,
    }
  },
