<template>
  <header id="header2">
    ...
    <router-link to="youtubecourse">一覧に戻る</router-link>
  </header>
  <h1 class="h">チャンネル登録しよう</h1>
  <img
...
export default {
  data() {
    return {
      ImgSrc: [
        require("@/imgs/Youtube/Likechannel/likechannel1.png"),

        require("@/imgs/Youtube/Likechannel/likechannel2.png"),

        require("@/imgs/Youtube/Likechannel/likechannel3.png"),
      ],
      currentIndex: -1,
    }
  },
